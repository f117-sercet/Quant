...
2)EV/Sales  
```markdown
企业价值倍数 = 企业价值EV / 销售收入 = 市场价值(总股本*股价)+总债务-现金及现金等价物
```  
...
#### 4.ROA（资产回报率）增长率 和 ROE（股东权益回报率）增长率  
ROA 描述的是公司如何利用其全部资产来产生盈利。一个高的 ROA 通常意味着公司在使用其资产来产生收入方面做得很好。
```markdown
ROA = 净利润 / 总资产 * 100%
```  
ROE 描述的是公司如何利用其股东权益（也就是投资者的投资）来产生盈利。一个高的 ROE 通常意味着公司在使用股东的资金来产生收入方面做得很好。
```markdown
ROE = 净利润 / 股东权益 * 100%
```    
